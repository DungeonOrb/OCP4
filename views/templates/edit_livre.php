        ...
        <div class="form-row">
          <div class="field">
            ...
            <input type="text" id="titre" name="titre"
                   value="<?= htmlspecialchars($livre->getTitre()) ?>" required>
          </div>

          <div class="field">
            <label for="auteur">Auteur</label>
            <input type="text" id="auteur" name="auteur"
                   value="<?= htmlspecialchars($livre->getAuteur()) ?>" required>
          </div>
        </div>

        <div class="field">
          <label for="content">Commentaire</label>
          <textarea id="content" name="content" rows="10" required><?= htmlspecialchars($livre->getContent()) ?></textarea>
        </div>
